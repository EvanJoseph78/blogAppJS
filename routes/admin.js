...
router.post('/categorias/nova', eAdmin, (req, res) => {
    ...
    if (req.body.nome.length < 2) {
        erros.push({
            texto: "Nome da categoria muito curto"
        })
    }
...
router.post("/categorias/deletar", eAdmin, (req, res) => {
    Categoria.deleteOne({ _id: req.body.id }).then(() => {
        ...
        req.flash("error_msg", "Ocorreu algum erro ao tentar deletar a categoria")
        res.redirect("/admin/categorias")
    })
})
...
router.post("/postagens/nova", eAdmin, (req, res) => {
    ...
    if (erros.length > 0) {
        ...
        new Postagem(novaPostagem).save().then(() => {
            ...
            req.flash("error_msg", "Houve um erro ao tentar criar postagem!")
            console.log("Ocorreu um erro " + err)
            res.redirect("/admin/postagens")
        })
    }
...
router.post("/postagens/deletar", eAdmin, (req, res) => {
    Postagem.deleteOne({ _id: req.body.id }).then(() => {
        ...
        req.flash("error_msg", "Ocorreu algum erro ao tentar deletar a postagem")
        res.redirect("/admin/postagens")
        console.log(err)
    })
})
